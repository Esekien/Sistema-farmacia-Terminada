...
"")
    ...
    def inserDatosBtn(self):
        try:
            ...
            if cantidadPuesta <= self.Query[2] and cantidadPuesta != 0 and cantidadPuesta > 0:
                #####################################
                ...
                if cantidadPuesta ==0 or cantidadPuesta < 0:
    ...
    def NcontrolS(self):  
        ...
        self.LineControlSalida.setText(str(self.Npedidoup))
        session.close()
