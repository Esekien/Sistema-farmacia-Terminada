...
"")
        ...
        self.actionuno = QtWidgets.QAction(Main)
        self.actionuno.setObjectName("Manual Tecnico")

        self.actiondos = QtWidgets.QAction(Main)
        self.actiondos.setObjectName("Acerca de..")
        ...
        self.menuAyuda.addAction(self.actionuno)
        self.menuAyuda.addAction(self.actiondos)
...
""").scalar()
    ...
    def retranslateUi(self, Main):
        ...
        self.actionuno.setText(_translate("Main", "Manual Tecnico"))
        self.actiondos.setText(_translate("Main", "Acerca de.."))
